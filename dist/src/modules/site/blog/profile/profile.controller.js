...
const profile_tdo_1 = require("./profile.tdo");
...
let ProfileController = class ProfileController {
    ...
    async get(slug) {
        ...
        if (!profile)
            throw new common_1.NotFoundException('Perfil não existe');
        return profile;
    }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, profile_tdo_1.UpdateProfileDto]),
    __metadata("design:returntype", Promise)
