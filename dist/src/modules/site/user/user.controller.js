...
let UserController = class UserController {
    ...
    async findAll() {
        ...
        if (!users.length)
            throw new common_1.NotFoundException(msgUser_1.msg.usersNotExist);
        return users;
    }
    async findOne(id) {
    ...
    async update(id, updateUser) {
        ...
        return { message: msgUser_1.msg.userUpdatedSucess, statusCode: 200 };
    }
    async remove(id) {
        await this.usersService.remove(id);
        return { message: msgUser_1.msg.userDeletedSucess, statusCode: 200 };
    }
};
__decorate([
    (0, common_1.Post)(),
